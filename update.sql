...
-- content_viewer_list_sme reference
DELETE FROM widgetcatalog WHERE code = 'content_viewer_list_sme';
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('content_viewer_list_sme','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
-- content_viewer_list_sme layout reference
DELETE FROM guifragment WHERE code = 'jacms_content_viewer_list_sme';
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('jacms_content_viewer_list_sme','content_viewer_list_sme','jacms','<#assign jacms=JspTaglibs["/jacms-aps-core"]>
<#assign wp=JspTaglibs["/aps-core"]>
<@jacms.contentList listName="contentList" titleVar="titleVar"pageLinkVar="pageLinkVar" pageLinkDescriptionVar="pageLinkDescriptionVar" userFilterOptionsVar="userFilterOptionsVar" />
...
INSERT INTO widgetconfig_draft (pagecode,framepos,widgetcode,config) VALUES ('sme_homepage',5,'content_viewer_list_slider','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
<property key="pageLink">sme_notizie</property>
</properties>
');

INSERT INTO widgetconfig (pagecode,framepos,widgetcode,config) VALUES ('sme_homepage',5,'content_viewer_list_slider','<?xml version="1.0" encoding="UTF-8"?>
<properties>
<property key="modelId">512</property>
<property key="maxElemForItem">8</property>
<property key="filters">(attributeFilter=true;value=true;key=Evidenza;order=DESC)</property>
